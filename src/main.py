...
from generate_fake_tables import POSTGRES_PASSWORD, POSTGRES_USER
...
if __name__ == "__main__":
    ...
    common_transactions = pd.merge(
        eligible_transactions_df, gtr_df, how="left", left_on="transaction_id", right_on="reported_id", indicator=True,
        suffixes=("_ct", "_gtr")
    )
